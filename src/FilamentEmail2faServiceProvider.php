...
{
    public static string $name = 'filament-email-2fa';

    public static string $viewNamespace = 'filament-email-2fa';
    ...
    public function packageBooted(): void
    {
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/filament-email-2fa/{$file->getFilename()}"),
                ], 'filament-email-2fa-stubs');
            }
        }
    ...
    {
        return 'solution-forest/filament-email-2fa';
    }
